...
GH-T66 --- Verify that the user can edit existing contract by clicking on Pencil icon next to the contract name
    [Tags]    High
    Login system with admin user account second
    Access Employees page
    Select an employee account
